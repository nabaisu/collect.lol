...
RSpec.describe "/rules", type: :request do
  ...
  # RulesController, or in your router and rack
  ...
  describe "GET /index" do
    it "renders a successful response" do
      ...
      get rules_url, headers: valid_headers, as: :json
  ...
  describe "POST /create" do
    ...
    context "with invalid parameters" do
      it "does not create a new Rule" do
        expect {
          post rules_url,
               params: { rule: invalid_attributes }, as: :json
  ...
  describe "DELETE /destroy" do
    it "destroys the requested rule" do
      rule = Rule.create! valid_attributes
      expect {
        delete rule_url(rule), headers: valid_headers, as: :json
      }.to change(Rule, :count).by(-1)
    end
  end
end
